...
public interface ShouldVisitFilterMapper {
     ...
     * @mbggenerated Thu Sep 25 22:18:07 CST 2014
     */
    int updateByExampleSelective(@Param("record") ShouldVisitFilter record, @Param("example") ShouldVisitFilterExample example);
     ...
     * @mbggenerated Thu Sep 25 22:18:07 CST 2014
     */
    int updateByExample(@Param("record") ShouldVisitFilter record, @Param("example") ShouldVisitFilterExample example);
